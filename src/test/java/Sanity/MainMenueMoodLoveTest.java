...
public class MainMenueMoodLoveTest extends BaseTest {
    ...
    @Test(groups ={"Artlist"}, description= "the script should click main menue Mood Love")
    public void MainMenueMoodLove() throws InterruptedException {
    	MainMenue mainMenue = new MainMenue(driver);
    	SearchHeader searchHeader = new SearchHeader(driver);
    	mainMenue.goTo();
        mainMenue.clickOnMainMenueMood();
        Thread.sleep(5000);
        mainMenue.clickOnMainMenueLove();
        Thread.sleep(3000);
