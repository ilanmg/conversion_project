...
public class MainMenueMoodPlayfulTest extends BaseTest {
    ...
    @Test(groups ={"Artlist"}, description= "the script should click main menue Mood Playful")
    public void MainMenueMoodPlayful() throws InterruptedException {
    	MainMenue mainMenue = new MainMenue(driver);
    	mainMenue.goTo();
        mainMenue.clickOnMainMenueMood();
        Thread.sleep(5000);
        mainMenue.clickOnMainMenuePlayful();
        Thread.sleep(3000);
