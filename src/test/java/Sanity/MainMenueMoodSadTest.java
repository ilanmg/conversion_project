...
public class MainMenueMoodSadTest extends BaseTest {
    ...
    @Test(groups ={"Artlist"}, description= "the script should click main menue Mood Sad")
    public void MainMenueMoodSad() throws InterruptedException {
    	MainMenue mainMenue = new MainMenue(driver);
    	SearchHeader searchHeader = new SearchHeader(driver);
    	mainMenue.goTo();
        mainMenue.clickOnMainMenueMood();
        Thread.sleep(5000);
        mainMenue.clickOnMainMenueSad();
        Thread.sleep(3000);
