...
public class MainMenueMoodSeriousTest extends BaseTest {
    ...
    @Test(groups ={"Artlist"}, description= "the script should click main menue Mood Serious")
    public void MainMenueMoodSerious() throws InterruptedException {
    	MainMenue mainMenue = new MainMenue(driver);
    	SearchHeader searchHeader = new SearchHeader(driver);
    	mainMenue.goTo();
        mainMenue.clickOnMainMenueMood();
        Thread.sleep(5000);
        mainMenue.clickOnMainMenueSerious();
        Thread.sleep(3000);
